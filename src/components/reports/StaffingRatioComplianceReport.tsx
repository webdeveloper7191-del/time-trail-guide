...
const tableColumns: DataTableColumn<StaffingRatioRecord>[] = [
  ...
  { key: 'timeSlot', header: 'Time', type: 'date', accessor: (r) => r.timeSlot, sortValue: (r) => r.timeSlot },
  ...
  { key: 'requiredStaff', header: 'Req. Staff', type: 'number', accessor: (r) => r.requiredStaff, sortValue: (r) => r.requiredStaff, align: 'right' },
...
export function StaffingRatioComplianceReport() {
  ...
  const baseFiltered = useMemo(() => filterByDateRange(mockStaffingRatios.filter(r => {

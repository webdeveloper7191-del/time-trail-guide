...
const tableColumns: DataTableColumn<WeeklyTimesheetRecord>[] = [
  ...
  { key: 'department', header: 'Dept', type: 'enum', accessor: (r) => <Badge variant="outline" className="text-[10px]">{r.department}</Badge>, sortValue: (r) => r.department },
  ...
  { key: 'daysWorked', header: 'Days', type: 'number', accessor: (r) => (

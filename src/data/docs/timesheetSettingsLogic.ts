    ...
    groups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            interactions: ['timeTracking.kioskVerificationMode', 'restrictToGeofence'],
          },
          {
          ...
          },
          {
            ...
            logic: [
              ...
              'Any mode that includes face verification makes the kiosk capture a photo with the punch; selecting "PIN only" does not.',
            ...
            interactions: ['timeTracking.enableMobileClock (Rostered.ai Kiosk App)', 'Timesheet Issues → Buddy punching detection'],
        ...
        items: [
          {
            ...
            interactions: ['timeTracking.kioskVerificationMode (face verification photo)', 'captureGpsOnMobile'],

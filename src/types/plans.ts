...
export const PLANS: Record<PlanTier, PlanDefinition> = {
  ...
  growth: {
    ...
    highlights: [
      ...
      'Payroll: pay runs, payslips, deductions and payroll reports',
  ...
  enterprise: {
    ...
    highlights: [
      ...
      'STP Phase 2 lodgement, ABA payment files and Xero / MYOB / QuickBooks posting',
...
const GROWTH: TierDelta = {
  ...
  subs: {
    ...
    'payroll::pay-calendars': true,
    'payroll::period-approval': true,
    'payroll::pay-runs': true,
    'payroll::approval': true,
    'payroll::unlock-reverse': true,
    'payroll::adjustments': true,
    'payroll::deductions': true,
    'payroll::tax-declarations': true,
    'payroll::super': true,
    'payroll::payslips': true,
...
const ENTERPRISE: TierDelta = {
  ...
  subs: {
    ...
    'payroll::stp': true,
    'payroll::accounting': true,
    'payroll::payments': true,
  },
};
